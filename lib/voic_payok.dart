...
class voic_payok extends StatefulWidget {
  @override
  _QuizPageState createState() => _QuizPageState();
}

class _QuizPageState extends State<voic_payok> {
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Future.delayed(Duration(seconds: 1), () {
                        if (questions[questionIndex]['aunwer'] as String == show as String) {
                          answerQuestion(1);
                        } else {
                          answerQuestion(0);
                        }
                      ...
                      colorc(questions[questionIndex]['aunwer'] as String == show as String
